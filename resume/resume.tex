...
\msection{Leadership}
\bt{Project Portal}\dash \emph{founder} \hfill 1/15$-$present

Developing a platform to increase visibility of student projects across campus programs

\gap

\bt{MIT Sandbox Fund}\dash \emph{student advisory board member} \hfill 1/15$-$present

Providing student perspective on running two-millon-dollar fund to support student projects

\gap

\bt{TechX}\dash \emph{ProjX committee member} \hfill 9/15$-$present

Funding and tracking student teams as they work on projects; hosting demo events
